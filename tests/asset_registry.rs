...
const RUNTIME_TEXTURES: [&str; 70] = [
    ...
    "assets/textures/tenant_body_poses_senior.png",
    "assets/textures/tenant_body_poses_indigo.png",
    "assets/textures/tenant_face_emotions.png",
    "assets/textures/tenant_face_emotions_alt.png",
    "assets/textures/tenant_face_emotions_senior.png",
    "assets/textures/tenant_face_emotions_indigo.png",
